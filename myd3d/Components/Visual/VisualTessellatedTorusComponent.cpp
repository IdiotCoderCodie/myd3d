#include "VisualTessellatedTorusComponent.h"
...
VisualTessellatedTorusComponent::VisualTessellatedTorusComponent(D3D& d3d, const std::string& filename,
...
VisualTessellatedTorusComponent::~VisualTessellatedTorusComponent(void)
{
}


void VisualTessellatedTorusComponent::InitTweakBar()
{
...
VisualTessellatedTorusComponent& VisualTessellatedTorusComponent::operator=(const VisualTessellatedTorusComponent& other)
{
    m_mesh = other.m_mesh;
    m_texture;
    m_heightMap;
...
void VisualTessellatedTorusComponent::ComponentID(componentId_t& out) const
{ 
    out = "VisualTessellatedTorusComponent"; 
}


void VisualTessellatedTorusComponent::Update(float timeElapsed)
{
...
void VisualTessellatedTorusComponent::ShadowPass(D3D& d3d)
{
    if(m_castShadows)
    {
...
void VisualTessellatedTorusComponent::Draw(D3D& d3d)
{
...
void VisualTessellatedTorusComponent::DrawNoShadows(D3D& d3d)
{
...
void VisualTessellatedTorusComponent::DrawWithShadows(D3D& d3d)
{
